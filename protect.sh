...
# ==================================================
# PROTECT BY YUDAMODS - PANEL PROTECTION SCRIPT
# Created by: YudaMods
# Version: 1.0
# ==================================================
...
class LocationController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, 'Protect by YudaMods - Akses ditolak');
        }
...
echo ""
echo -e "${GREEN}==================================================${NC}"
echo -e "${GREEN}    PROTECT BY YUDAMODS INSTALLATION COMPLETE!${NC}"
echo -e "${GREEN}            Created by YudaMods${NC}"
echo -e "${GREEN}==================================================${NC}"
echo ""
...
echo ""
echo -e "${BLUE}Your Pterodactyl panel is now protected by YudaMods!${NC}"
echo ""
